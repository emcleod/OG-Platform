...
/**
 * Generates a portfolio of USD, GBP, JPY and EUR OIS.
 * @author emcleod
 */
public class OISPortfolioGeneratorTool extends AbstractPortfolioGeneratorTool {
  ...
  private static final class OISSecurityGenerator extends SecurityGenerator<SwapSecurity> {
    /** The logger */
    private static final Logger s_logger = LoggerFactory.getLogger(OISPortfolioGeneratorTool.OISSecurityGenerator.class);
